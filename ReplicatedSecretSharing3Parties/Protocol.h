...
public:
    Protocol(int id,TemplateField<FieldType> *field, string inputsFile, string outputFile, string circuitFile, string address,
             ProtocolTimer* protocolTimer);
...
template <class FieldType>
Protocol<FieldType>::Protocol(int id, TemplateField<FieldType> *field, string inputsFile, string outputFile, string circuitFile, string address,
                              ProtocolTimer* protocolTimer)
{
...
template <class FieldType>
void Protocol<FieldType>::generateRandomness31Bits() {
...
template <class FieldType>
void Protocol<FieldType>::generateRandomness61Bits() {
...
template <class FieldType>
void Protocol<FieldType>::generateCForTriples(vector<FieldType>& alpha_for_triple, int numOfMult) {
...
template <class FieldType>
void Protocol<FieldType>::verification(vector<FieldType>& x_triple, vector<FieldType>& y_triple, vector<FieldType>& z_triple,
                                           vector<FieldType>& a_triple, vector<FieldType>& b_triple, vector<FieldType>& c_triple, int numOfMult)
{
...
template <class FieldType>
void Protocol<FieldType>::comparingViews(vector<FieldType>& hi,vector<FieldType>& hiPlus1,vector<FieldType>& hiMinus1, int NrOfMultiplicationGates,
...
template <class FieldType>
void Protocol<FieldType>::inputPreparation()
{
    int robin = 0;
...
template <class FieldType>
vector<byte> Protocol<FieldType>::generateCommonKey(vector<FieldType>& aesArray){
...
template <class FieldType>
void Protocol<FieldType>::computationPhase() {
...
template <class FieldType>
void Protocol<FieldType>::sendNext(vector<byte> &sendBufs, vector<byte> &recBufs) {
